...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/ArticleTags/index">
            ...
            <div class="panel-collapse collapse in">
                ...
                <div class="panel-body">
                  <div class="row panel-scroll">  
                        ...
                        <div class="col-sm-12">
                        <a href="<?php echo U('/Admin/ArticleTags/add');?>" class="btn btn-success">添加</a>
                        </div>  
                     <div class="col-sm-12">
                         <table class="table table-hover">
                             <thead>
                                <tr>
                                    ...
                                    <th class="center">标签名</th>
                                    <th class="center">排序</th>
                                    <th class="center">操作</th>
                                </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($ArticleTags)): foreach($ArticleTags as $key=>$vo): ?><tr class="ng-scope">
                                       ...
                                       <td>
                                        ...
                                        <td id="<?php echo ($vo["id"]); ?>">
                                            <div class="left">
                                                <a href="/Admin/ArticleTags/edit?id=<?php echo ($vo["id"]); ?>" class="btn btn-sm btn-info">修改</a>
...
<script type="text/javascript">
    ...
    $(function() {
        $(".inputorder").change(function() {
            ...
            var sort = $(this).val();
            if (sort && id) {
                $.post("<?php echo U('/admin/ArticleTags/updateSort');?>", {
                    id: id,
                    sort: sort
                }, function(data) {
                    if (data == 1) {
