...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/ArticleTags/add.html">
    <div class="console-container ng-scope">
        ...
        <div class="row">
    <div class="col-sm-8">
        <form action="/admin/ArticleTags/add" method="POST" id="formData" data-ajax='true' class="form-horizontal autoBootstrapValidator">

            <div class="form-group">
                <label for="name" class="col-sm-3 control-label">标签名称：</label>
                <div class="col-sm-5">
                    <input type="text" class="form-control" name="name" check-type="required" placeholder="标签名称">
                </div>
            </div>
            <div class="form-group">
                <label for="sort" class="col-sm-3 control-label">排序：</label>
                <div class="col-sm-5">
                    <input type="number" class="form-control" name="sort" placeholder="数字,越小越靠前">
                </div>
            </div>
             <div class="form-group">
