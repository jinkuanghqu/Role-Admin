...
<html lang="en">
    ...
    <!-- topbar -->
        ...
        <div class="topbar-wrap topbar-clearfix">
            <div class="topbar-head topbar-left"><a href="javasrcipt:;" onclick="mainFrame.window.location.reload();" class="topbar-logo topbar-left"><span class="icon-oas-2"></span></a> <a href="/admin/index/index" target="_self" class="topbar-home-link topbar-btn topbar-left" ><span class="ng-binding">金矿-管理控制台</span></a>
            </div>
