...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/Article/edit?id=77">
        ...
        <form class="form-horizontal autoBootstrapValidator" action="" data-ajax='true' method="POST" name="formData" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select id="tags" name="tags" class="form-control">
                    ...
                    <?php if(is_array($tags)): $i = 0; $__LIST__ = $tags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($art['tags'] == $vo['id']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
                </div>
            </div> 
             ...
             <div class="form-group">
                ...
                <select id="is_top" name="is_top" class="form-control">
                    <option value="0" <?php if($art['is_top'] == 0): ?>selected<?php endif; ?>>否</option>
                    <option value="1" <?php if($art['is_top'] == 1): ?>selected<?php endif; ?>>是</option>
                </select>
                </div>
            </div> 
