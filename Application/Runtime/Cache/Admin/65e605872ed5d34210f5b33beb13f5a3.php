...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/User/index">
                    ...
                    <div class="row panel-scroll">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php if(is_array($userRows)): $i = 0; $__LIST__ = $userRows;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$userRow): $mod = ($i % 2 );++$i;?><tr class="info">
                                            <td><?php echo ($userRow["id"]); ?></input></td>
                                            <td><img src="<?php echo ($userRow["headimgurl"]); ?>" width="60" height="60"></input></td>
                                            <td><?php echo ($userRow["nickname"]); ?></td>
                                            <td><?php echo ($userRow["sex"]); ?></td>
                                            <td>
                                                <?php echo ($userRow["country"]); ?>
                                            </td>
                                            <td><?php echo ($userRow["province"]); ?></td>
                                            <td>
                                                <?php echo ($userRow["city"]); ?>
                                            </td>
                                            <td>
                                                <?php echo ($userRow["integral"]); ?>
                                            </td>
