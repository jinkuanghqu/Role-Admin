...
<body class="iframe-body" data-sid="<?php echo ($adminRow["id"]); ?>" data-settime="<?php echo (C("IFRAME_BODY_SETTIME")); ?>" data-actionurl="/Admin/Article/index">
            ...
            <div class="panel-collapse collapse in">
                <div class="panel-body">
                    <div class="row panel-scroll">
                        <div class="col-sm-12">
                            <a href="<?php echo U('/Admin/Article/add');?>" class="btn btn-success">添加</a>
                        </div>
                        <div class="col-sm-12">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if(is_array($arts)): foreach($arts as $key=>$vo): ?><tr class="ng-scope">
                                            <td>
                                                <div class="center"><span class="ng-binding"><?php echo ($vo["name"]); ?></span></div>
                                            </td>
                                            <td>
                                                <div class="center"><span class="ng-binding"><?php echo ($vo["title"]); ?></span></div>
                                            </td>
                                            <td>
                                                <div class="center"><span class="ng-binding"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></span></div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="center"><span class="ng-binding"><?php echo ($vo['tags']); ?></span></div>
                                            </td>
                                            <td>
                                                <div class="center"><span class="ng-binding"><?php if($vo["is_top"] == 1): ?>是<?php else: ?>否<?php endif; ?></span></div>
                                            </td>
                                            <td>
                                                <div class="left">
                                                    <a href="/Admin/Article/edit?id=<?php echo ($vo["id"]); ?>" class="btn btn-sm btn-info">修改</a>
                                                    <a href="/Admin/Article/delete?id=<?php echo ($vo["id"]); ?>" class="btn btn-sm btn-info" id="del" onclick="if(!confirm('确认删除？')){return false;}">删除</a>
                                                </div>
                                            </td>
...
$(function() {
    $(".inputorder").change(function() {
        ...
        var sort = $(this).val();
        if (sort && id) {
            $.post("<?php echo U('/admin/Article/updateSort');?>", {
                id: id,
                sort: sort
            }, function(data) {
                if (data == 1) {
